...
type CreatePaymentRequest struct {
	...
	Currency      string                 `protobuf:"bytes,4,opt,name=currency,proto3" json:"currency,omitempty"` // e.g. "idr", "usd"
...
type CreatePaymentResponse struct {
	...
	PaymentUrl    string                 `protobuf:"bytes,2,opt,name=payment_url,json=paymentUrl,proto3" json:"payment_url,omitempty"` // URL redirect ke Stripe
...
type HandleWebhookRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Payload       []byte                 `protobuf:"bytes,1,opt,name=payload,proto3" json:"payload,omitempty"`     // Raw JSON body
	Signature     string                 `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"` // Header 'Stripe-Signature'
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_payment_proto_rawDesc = "" +
	"\n" +
	"\x13proto/payment.proto\x12\apayment\"\x82\x01\n" +
	...
	"\rCreatePayment\x12\x1d.payment.CreatePaymentRequest\x1a\x1e.payment.CreatePaymentResponse\x12N\n" +
	"\rHandleWebhook\x12\x1d.payment.HandleWebhookRequest\x1a\x1e.payment.HandleWebhookResponseB\x16Z\x14shared/proto/paymentb\x06proto3"
...
var file_proto_payment_proto_goTypes = []any{
	...
	(*HandleWebhookRequest)(nil),  // 2: payment.HandleWebhookRequest
	(*HandleWebhookResponse)(nil), // 3: payment.HandleWebhookResponse
}
var file_proto_payment_proto_depIdxs = []int32{
	...
	2, // 1: payment.PaymentService.HandleWebhook:input_type -> payment.HandleWebhookRequest
	1, // 2: payment.PaymentService.CreatePayment:output_type -> payment.CreatePaymentResponse
	3, // 3: payment.PaymentService.HandleWebhook:output_type -> payment.HandleWebhookResponse
