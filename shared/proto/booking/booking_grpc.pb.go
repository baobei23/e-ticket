...
const (
	...
	BookingService_GetBookingDetail_FullMethodName = "/booking.BookingService/GetBookingDetail"
)
...
type BookingServiceClient interface {
	...
	GetBookingDetail(ctx context.Context, in *GetBookingDetailRequest, opts ...grpc.CallOption) (*GetBookingDetailResponse, error)
}
...
func (c *bookingServiceClient) GetBookingDetail(ctx context.Context, in *GetBookingDetailRequest, opts ...grpc.CallOption) (*GetBookingDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookingDetailResponse)
...
type BookingServiceServer interface {
	...
	GetBookingDetail(context.Context, *GetBookingDetailRequest) (*GetBookingDetailResponse, error)
...
func (UnimplementedBookingServiceServer) GetBookingDetail(context.Context, *GetBookingDetailRequest) (*GetBookingDetailResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBookingDetail not implemented")
}
...
func _BookingService_GetBookingDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookingDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetBookingDetail(ctx, req.(*GetBookingDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
